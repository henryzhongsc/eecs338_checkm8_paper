% Professor feedback:
% Less on whats jailbreaking.
% More footnote on buzz words (words with no wiki?), add 3-4.
% Drop 3-4 buzz words, maybe introduce in a in-line manner.
% More in-line reference on ``previous sections''.
% Shorten the list if still possible.
